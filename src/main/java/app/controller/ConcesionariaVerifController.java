...
public class ConcesionariaVerifController {
    ...
    public ResponseEntity<?> getConcesinariaVerif(@PathVariable long concesinariaVerifId) {
        try {
            ConcesionarioTallerVerif concesionarioTallerVerif = concesionariaVerifService.findById(concesinariaVerifId);
            ConcesionariaVerifDTO dto = new ConcesionariaVerifDTO(concesionarioTallerVerif);
